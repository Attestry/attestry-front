...
const RetailTransferBrandListView = () => {
  ...
  const loadKey = `${canReadRetailTransfers}:${refreshTick}`;
  ...
  }, [canReadRetailTransfers, fetchPartnerLinks, loadKey]);
    ...
    <div className="max-w-6xl mx-auto space-y-6 p-4 sm:p-6 lg:p-8">
      <header className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">브랜드를 선택하면 해당 브랜드의 양도 완료 제품 목록으로 이동합니다.</p>
        </div>
            ...
            <div className="divide-y divide-gray-100">
              {pagedBrands.map((brand) => (
                <button
                  ...
                  type="button"
                  onClick={() => navigate(`/retail/transfer/${brand.brandTenantId}`, {
                    state: {
...
export default RetailTransferBrandListView;
