        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
            <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-10 w-full">
                ...
                <div className="flex gap-8 text-sm font-medium text-gray-600 hidden md:flex">
                    <Link to="/" className="hover:text-gray-900">소유권 이전 받기</Link>
                    <Link to="/" className="hover:text-gray-900">소유권 양도하기</Link>
                    <Link to="/" className="hover:text-gray-900">디지털 자산 보기</Link>
                    <Link to="/onboarding" className="text-blue-600 hover:text-blue-700 font-semibold">업체 신청</Link>
                </div>
                    ...
                    {isAuthenticated ? (
                        <div className="flex items-center gap-4">
                            ...
                            <button onClick={() => {
                                ...
                                navigate('/');
                            }} className="text-sm font-medium text-gray-500 hover:text-red-600 pl-4 border-l border-gray-200">로그아웃</button>
                        </div>
                    ) : (
